    ...
    def get_grn_grading_yield_data(
        ...
        query_params = {
            "dimensions": [
                ...
                "INDENT_GRN.created_at",
                "INDENT_GRN.hl_weight",
                "INDENT_GRN.unit_name",
                "INDENT_GRN.status",
                "INDENT_GRN.grn_created_at",
            ],
    ...
    def get_soaking_yield_data(
        ...
        query_params = {
            "dimensions": [
                ...
                "SOAKING_ALERT.sale_order",
                "SOAKING_ALERT.soak_time",
                "SOAKING_ALERT.created_at",
                "SOAKING_ALERT.updated_at",
                "SOAKING_ALERT.soaking_weight",
                "SOAKING_ALERT.status",
                "SOAKING_ALERT.soak_started_at",
                "SOAKING_ALERT.closed_at",
            ],
    ...
    def get_packing_yield_data(
        ...
        query_params = {
            "dimensions": [
                ...
                "PACKING_YIELD.created_at",
                "PACKING_YIELD.updated_at",
                "PACKING_YIELD.status",
            ],
